...
const Possibility = () => (
    <div className="possibility" id="possibility">
        ...
        <div className="possibility-content">
            ...
            <h1 style={{fontSize:'30px',fontWeight:'500',lineHeight:'45px',margin:'1rem 0',background: 'linear-gradient(89.97deg, #134580 1.84%, #04001D 102.67%)',color:'aliceblue'}}>Create and Take meets</h1>
