...
const Possibility = () => (
    <div className="possibility" id="possibility">
        ...
        <div className="possibility-content">
            <h4 id='possibility-h4'>Refmeet for a reason</h4>
            <h1 style={{fontSize:'34px',fontWeight:'500',lineHeight:'45px',margin:'1rem 0',background: 'linear-gradient(89.97deg, #134580 1.84%, #04001D 102.67%)',color:'aliceblue'}}>Hello Myaur and Harshal<br /> How Was your sleep</h1>
